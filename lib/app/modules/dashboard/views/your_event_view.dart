import 'package:belajar_flutter/app/modules/dashboard/views/add_view.dart';
import 'package:belajar_flutter/app/modules/dashboard/views/edit_view.dart';
...
class YourEventView extends GetView {
  ...
  children: [
    ...
    TextButton.icon(
      ...
      onPressed: () {
        // Panggil fungsi buat hapus event, tinggal lempar ID-nya
controller.deleteEvent(id: event.id!); // Pakai ID event yang mau dihapus
      },
    ),
  ],
),
